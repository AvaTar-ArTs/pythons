...
class DeepResearcher:
    ...
    def analyze(self) -> AnalysisResult:
        ...
        codex_configs = self.codex_generator.generate_configs(
    ...
    def export_results(:
        self, result: AnalysisResult, formats: List[str], output_dir: str = None
    ):
...
"""
    ...
    def _generate_tree_structure(:
        self, result: AnalysisResult, max_depth: int = 3
    ) -> str:
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="Deep Research Tool - Intelligent folder analysis"
    )
    parser.add_argument("--path", "-p", required=True, help="Root path to analyze")
    parser.add_argument(
        "--depth", "-d", type=int, default=6, help="Maximum depth to analyze"
    )
    parser.add_argument(
        "--github-mode", action="store_true", help="Enable GitHub repository analysis"
    )
    parser.add_argument(
        "--export",
        "-e",
        ...
        choices=["csv", "html", "json", "markdown"],
        help="Export formats",
    )
    ...
    parser.add_argument(
        "--generate-github",
        action="store_true",
        help="Generate GitHub repository structure",
    )
    ...
    researcher = DeepResearcher(
        root_path=args.path, max_depth=args.depth, github_mode=args.github_mode
    )
