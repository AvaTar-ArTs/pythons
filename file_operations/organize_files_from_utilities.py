...
def organize_files(base_dir):
    ...
    keep_files = {
        ...
        # Exports to keep
        "chat-export.md": "exports/AI-Art-Prompt-Engineering-ChatGPT-2025-10-17.md",
    ...
    archive_files = [
        ...
        "chat-export (2).md",
        "chat-export (3).md",
        "grok-FULL-conversation-1msgs-2025-10-17T08-26-18.md",
        "grok-FULL-conversation-1msgs-2025-10-17T08-56-30.md",
    ]
...
def create_summary_report(base_path, moved_count, archived_count):
    ...
    with open(report_path, "w", encoding="utf-8") as f:
        ...
        f.write("│   ├── AI-Art-Prompt-Engineering-ChatGPT-2025-10-17.md\n")
        ...
        f.write("│   ├── grok-FULL-conversation-1msgs-2025-10-17T08-26-18.md\n")
        f.write("│   └── grok-FULL-conversation-1msgs-2025-10-17T08-56-30.md\n")
...
def main():
    base_dir = "/Users/steven/SUNO/10-14"

    print("AI Export Tools Organization Script")
    print("=" * 40)
    ...
    print(f"✓ Files moved to organized structure: {moved_count}")
    print(f"✓ Files archived: {archived_count}")
    print(f"✓ Total files processed: {moved_count + archived_count}")
