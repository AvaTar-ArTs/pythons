...
class AggressiveCleanup:
    def __init__(self, pythons_dir="/Users/steven/pythons"):
        ...
        self.moves = {
            ...
            # VIDEO PROCESSING
            "MEDIA_PROCESSING/video_tools": ["videoGenerator", "video_processing"],
            # DATA/DOCS
            "DATA_UTILITIES": ["data", "data-analyzer", "doc-generator"],
            # SCRAPERS/WEB
            ...
            "content_creation/quiz": ["quiz-talk"],
            # IMAGE TOOLS
            ...
            # AUDIO TOOLS
            "audio_generation/spotify": ["savify", "SpotifyMP3"],
            "audio_generation/tts": ["tts_engines"],
            # DOCUMENTATION
            "documentation": [
            ...
            "_notebooks": ["colab"],
            # ARTICLES/CONTENT
            "content_creation/articles": ["intelligent_articles"],
        }
        ...
        self.delete = [
            ...
            "clean-organizer",
            "clean_1 2",
            "ENV_D_ANALYSIS_20251201_054751",
            "ENV_D_ZSHRC_COMPARISON_20251201_055039",
            "MULTI_DEPTH_ANALYSIS_20251201_050441",
            "MULTI_DEPTH_ANALYSIS_20251201_050647",
