...
def main():
    ...
    analyze_parser.add_argument(
        "--tool",
        default="python_complexity_analyzer",
    ...
    info_parser.add_argument(
        "--category",
        choices=["analysis", "cleanup", "dedup", "rename", "scanners"],
        help="Show tools in specific category",
    )
    info_parser.add_argument(
        "--all", action="store_true", help="Show all available tools"
    )
