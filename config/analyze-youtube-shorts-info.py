...
"""
Summary of analyze-youtube-shorts-info.py
...
# Directory paths
AUDIO_DIR = Path(
    str(Path.home()) + "/Movies/poject2025/mp4"
)  # Directory containing MP3 files
TRANSCRIPT_DIR = Path(
    str(Path.home()) + "/Movies/poject2025/mp4/transcript"
)  # Directory to save transcripts
ANALYSIS_DIR = Path(
    str(Path.home()) + "/Movies/poject2025/mp4/analysis"
