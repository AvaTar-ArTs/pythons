...
class AICourseCreator:
    ...
    def _generate_course_outline(:
        self, topic: str, level: str, duration_hours: int
    ) -> Dict[str, Any]:
        ...
        try:
            ...
            response = self.openai_client.chat.completions.create(
                ...
                messages=[
                    {
                        "role": "system",
                        "content": "You are an expert course designer and educator.",
                    },
        ...
        try:
            ...
            response = self.openai_client.chat.completions.create(
                ...
                messages=[
                    {
                        "role": "system",
                        "content": "You are an expert educator creating detailed course content.",
                    },
                    {"role": "user", "content": prompt},
                ],
                temperature=0.7,
            ...
            return self._create_default_module(
                course_id, module_index, module_outline, level
            )
