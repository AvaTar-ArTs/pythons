...
class EvalFirstStepCallback(TrainerCallback):  # pylint: disable=too-few-public-methods disable=unused-argument
    """
...
class SaveBetterTransformerModelCallback(TrainerCallback):  # pylint: disable=too-few-public-methods
...
class GPUStatsCallback(TrainerCallback):  # pylint: disable=too-few-public-methods disable=unused-argument
        ...
        def on_evaluate(:
            ...
            **kwargs,  # pylint: disable=unused-argument
            ...
            if is_distributed() and not is_main_process():
                ...
                bench_refs = []
                bench_preds = []
                for bench_name in combined_bench_names:  # pylint: disable=consider-using-dict-items
