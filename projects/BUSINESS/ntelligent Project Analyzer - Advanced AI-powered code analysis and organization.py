...
try:
    from code_intelligence_engine import (
...
class IntelligentProjectAnalyzer:
    ...
    def analyze_project_comprehensive(self, project_path: str) -> Dict[str, Any]:
        ...
        performance_recommendations = self._analyze_performance_patterns(
            analysis_results
        )
        ...
        comprehensive_analysis = {
            ...
            "overall_score": self._calculate_overall_score(
                analysis_results, enhanced_insights
            ),
        }
    ...
    def _generate_enhanced_insights(:
        ...
        insights["code_quality_metrics"] = {
            ...
            "category_diversity": len(
                set(f.get("category", "unknown") for f in files_analyzed)
            ),
            "intelligence_distribution": overall_intelligence.get(
        ...
        insights["scalability_assessment"] = {
            ...
            "scalability_recommendations": self._generate_scalability_recommendations(
                files_analyzed
            ),
        }
        ...
        insights["innovation_indicators"]["innovation_score"] = sum(
            innovation_factors
        ) / len(innovation_factors)

        # Learning recommendations
        insights["learning_recommendations"] = self._generate_learning_recommendations(
            insights
        )
    ...
    def _analyze_architecture(self, analysis_results: Dict[str, Any]) -> Dict[str, Any]:
        ...
        architecture_analysis["architectural_recommendations"] = (
    ...
    def _analyze_performance_patterns(:
        ...
        performance_analysis["performance_indicators"] = {
            ...
            "function_size_distribution": self._analyze_function_size_distribution(
                files_analyzed
            ),
            "import_analysis": self._analyze_import_patterns(files_analyzed),
            "resource_intensive_patterns": self._identify_resource_intensive_patterns(
                files_analyzed
            ),
        }
        ...
        performance_analysis["bottleneck_analysis"] = {
            "high_complexity_files": self._identify_high_complexity_files(
                files_analyzed
            ),
            "potential_bottlenecks": self._identify_potential_bottlenecks(
                files_analyzed
            ),
        ...
        performance_analysis["optimization_opportunities"] = (
            self._identify_optimization_opportunities(files_analyzed)
        )
    ...
    def _analyze_security_patterns(:
        ...
        security_analysis["security_indicators"] = {
            ...
            "authentication_patterns": self._assess_authentication_patterns(
                files_analyzed
            ),
        ...
        security_analysis["vulnerability_assessment"] = {
            "potential_vulnerabilities": self._identify_potential_vulnerabilities(
                files_analyzed
            ),
        ...
        security_analysis["security_recommendations"] = (
    ...
    def _analyze_business_patterns(:
        ...
        business_analysis["business_value_indicators"] = {
            "lead_generation_capability": self._assess_lead_generation_capability(
                files_analyzed
            ),
            "automation_level": self._assess_automation_level(files_analyzed),
        ...
        business_analysis["revenue_generation_patterns"] = {
            "monetization_strategies": self._identify_monetization_strategies(
                files_analyzed
            ),
            "pricing_model_support": self._assess_pricing_model_support(files_analyzed),
            "customer_acquisition_tools": self._assess_customer_acquisition_tools(
                files_analyzed
            ),
        ...
        business_analysis["customer_experience_patterns"] = {
            "user_interface_quality": self._assess_user_interface_quality(
                files_analyzed
            ),
            "response_time_optimization": self._assess_response_time_optimization(
                files_analyzed
            ),
            "error_handling_quality": self._assess_error_handling_quality(
                files_analyzed
            ),
            "accessibility_features": self._assess_accessibility_features(
                files_analyzed
            ),
        }

        # Business recommendations
        business_analysis["business_recommendations"] = (
    ...
    def generate_visualizations(:
        ...
        output_dir: str = "analysis_visualizations",
    ):
    ...
    def _create_project_overview_dashboard(:
        ...
        if intelligence_dist:
            fig.add_trace(
                go.Pie(
                    labels=list(intelligence_dist.keys()),
                    values=list(intelligence_dist.values()),
                    name="Intelligence",
                ),
                row=1,
                col=2,
        ...
        if confidences:
            fig.add_trace(
                go.Histogram(x=confidences, name="Confidence", nbinsx=10), row=2, col=1
            )
    ...
    def _create_code_quality_visualizations(:
        self, analysis_results: Dict[str, Any], output_path: Path
    ):
        ...
        if not df.empty:
            ...
            fig = px.bar(
                df.groupby("intelligence_level").size().reset_index(name="count"),
                x="intelligence_level",
                y="count",
                title="Intelligence Level Distribution",
            )
            fig.write_html(output_path / "intelligence_distribution.html")

    def _create_architecture_visualizations(:
        self, analysis_results: Dict[str, Any], output_path: Path
    ):
        ...
        if architectural_patterns:
            ...
            fig = px.bar(
                x=architectural_patterns,
                y=[1] * len(architectural_patterns),
    ...
    def _create_performance_visualizations(:
        ...
        if files_analyzed:
            ...
            fig = px.imshow(
                df[["confidence", "intelligence_level"]].corr(),
                title="Performance Metrics Correlation",
            )
            fig.write_html(output_path / "performance_heatmap.html")

    def _create_business_intelligence_dashboard(:
        self, analysis_results: Dict[str, Any], output_path: Path
    ):
        ...
        if business_intelligence:
            # Business value indicators
            value_indicators = business_intelligence.get(
                "business_value_indicators", {}
            )
            if value_indicators:
                fig = px.bar(
                    x=list(value_indicators.keys()),
                    y=list(value_indicators.values()),
                    title="Business Value Indicators",
                )
                fig.write_html(output_path / "business_value_indicators.html")

    def _calculate_overall_score(:
        self, analysis_results: Dict[str, Any], enhanced_insights: Dict[str, Any]
    ) -> Dict[str, float]:
        ...
        innovation_score = enhanced_insights.get("innovation_indicators", {}).get(
            "innovation_score", 0.0
        )
    ...
    def _fallback_analysis(self, project_path: str) -> Dict[str, Any]:
        ...
        return {
            ...
            "files_analyzed": [
                {"file": str(f), "category": "unknown", "confidence": 0.5}
    ...
    def _assess_separation_of_concerns(self, files_analyzed: List[Dict]) -> float:
        ...
        return (
            min(unique_categories / len(files_analyzed), 1.0) if files_analyzed else 0.0
        )
    ...
    def _assess_complexity_debt(self, files_analyzed: List[Dict]) -> float:
        ...
        high_complexity_files = sum(
            1 for f in files_analyzed if f.get("confidence", 0) < 0.5
        )
    ...
    def _assess_test_coverage_debt(self, files_analyzed: List[Dict]) -> float:
        ...
        test_files = sum(
            1 for f in files_analyzed if "test" in f.get("file", "").lower()
        )
        return (
            max(0, 1.0 - (test_files / len(files_analyzed))) if files_analyzed else 1.0
        )
    ...
    def _identify_refactoring_priorities(self, files_analyzed: List[Dict]) -> List[str]:
        ...
        for f in files_analyzed:
            if f.get("confidence", 0) < 0.5:
                priorities.append(
                    f"Refactor {f.get('file', 'unknown')} - low confidence"
                )
    ...
    def _assess_automation_level(self, files_analyzed: List[Dict]) -> float:
        ...
        automation_files = sum(
            1
            for f in files_analyzed
            if f.get("category") in ["lead_generation", "data_processing"]
        )
    ...
    def _generate_learning_recommendations(self, insights: Dict[str, Any]) -> List[str]:
        ...
        innovation_score = insights.get("innovation_indicators", {}).get(
            "innovation_score", 0
        )
    ...
    def _generate_architectural_recommendations(:
        self, quality: Dict, principles: Dict
    ) -> List[str]:
    ...
    def _analyze_function_size_distribution(:
        self, files_analyzed: List[Dict]
    ) -> Dict[str, Any]:
    ...
    def _identify_resource_intensive_patterns(:
        self, files_analyzed: List[Dict]
    ) -> List[str]:
    ...
    def _identify_high_complexity_files(self, files_analyzed: List[Dict]) -> List[str]:
        return [
            f.get("file", "") for f in files_analyzed if f.get("confidence", 0) < 0.5
        ][:3]
    ...
    def _generate_performance_recommendations(:
        self, indicators: Dict, bottlenecks: Dict
    ) -> List[str]:
    ...
    def _generate_security_recommendations(:
        self, indicators: Dict, vulnerabilities: Dict
    ) -> List[str]:
        return [
    ...
    def _assess_lead_generation_capability(self, files_analyzed: List[Dict]) -> float:
        lead_files = sum(
            1 for f in files_analyzed if f.get("category") == "lead_generation"
        )
    ...
    def _identify_monetization_strategies(:
        self, files_analyzed: List[Dict]
    ) -> List[str]:
    ...
    def _generate_business_recommendations(:
        self, value: Dict, revenue: Dict, experience: Dict
    ) -> List[str]:
        return [
