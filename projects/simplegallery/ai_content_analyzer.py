...
class AIContentAnalyzer:
    ...
    def _analyze_mood(self, image: Image.Image) -> Dict[str, Any]:
        ...
        try:
            ...
            overall_mood = self._combine_mood_indicators(
                color_mood, brightness_mood, composition_mood
            )
    ...
    def _combine_mood_indicators(:
        self, color_mood: str, brightness_mood: str, composition_mood: str
    ) -> str:
        """Combine mood indicators"""
