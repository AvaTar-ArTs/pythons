...
class ContentAnalyzer:
    ...
    def extract_enhanced_metadata(:
        self, image_path: str, thumbnail_path: str, public_path: str
    ) -> Dict[str, Any]:
        """
    ...
    def _analyze_faces(self, image_path: str) -> Dict[str, Any]:
        ...
        try:
            ...
            face_analysis = {
                ...
                "largest_face_size": max([w * h for (x, y, w, h) in faces])
                if len(faces) > 0
                else 0,
            ...
            try:
                ...
                if exif and ExifTags.TAGS.get(271) in exif:  # DateTimeOriginal
                    exif_time = datetime.strptime(
                        exif[ExifTags.TAGS.get(271)], "%Y:%m:%d %H:%M:%S"
                    )
            except:
                pass
        ...
        try:
            ...
            if ExifTags.TAGS.get(270) in exif:  # ImageDescription
                ...
                if description and any(
                    ...
                    for keyword in ["location", "place", "city", "country"]
                ):
    ...
    def _calculate_aesthetic_score(self, image_path: str) -> Dict[str, Any]:
        ...
        try:
            ...
            overall_score = sum(
                aesthetic_factors[key] * weights[key] for key in weights.keys()
            )
...
def get_enhanced_metadata(:
    image_path: str, thumbnail_path: str, public_path: str
) -> Dict[str, Any]:
    """
