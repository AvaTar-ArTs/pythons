...
class AudioVideoProcessor:
    ...
    def detect_viral_moments(:
        self, transcript_data, keywords=["amazing", "wow", "insane", "clutch"]
    ):
        """
...
class TwitchAPIHandler:
    ...
    def download_clip_for_editing(self, clip_url, output_path):
        ...
        """
        print("⬇️ Downloading viral clip from Twitch...")
    ...
    def create_automated_highlight_reel(self, broadcaster_id, output_dir, top_n=5):
        ...
        print(
            f"✅ Automated highlight reel ready! {len(downloaded_files)} clips downloaded."
        )
...
def automate_twitch_to_tiktok(broadcaster_id, twitch_client_id, twitch_token):
    ...
    clips = twitch.create_automated_highlight_reel(
        broadcaster_id=broadcaster_id, output_dir="./twitch_highlights", top_n=5
    )
...
def main():
    ...
    print("✅ Optimized platforms: TikTok, YouTube Shorts, Instagram Reels, Twitter\n")
    ...
    print(
        "   clips = processor.batch_extract_highlights('video.mp4', timestamps, './out')\n"
    )
