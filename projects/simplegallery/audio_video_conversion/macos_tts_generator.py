...
def generate_audiobook_macos():
    ...
    print("🎙️ Generating 'As a Man Thinketh' Audiobook using macOS TTS")
    print("=" * 70)
...
JAMES ALLEN. BROAD PARK AVENUE, ILFRACOMBE, ENGLAND"""
    ...
    try:
        ...
        print("✅ Foreword generated successfully")

    except Exception as e:
        print(f"❌ Error generating Foreword: {e!s}")
        return False
...
In this direction, as in no other, is the law absolute that "He that seeketh findeth; and to him that knocketh it shall be opened;" for only by patience, practice, and ceaseless importunity can a man enter the Door of the Temple of Knowledge."""
    ...
    try:
        ...
        print("✅ Thought and Character generated successfully")

    except Exception as e:
        print(f"❌ Error generating Thought and Character: {e!s}")
        return False
...
"So You will be what you will to be; Let failure find its false content In that poor word, 'environment,' But spirit scorns it, and is free. It masters time, it conquers space; It cowes that boastful trickster, Chance, And bids the tyrant Circumstance Uncrown, and fill a servant's place. The human Will, that force unseen, The offspring of a deathless Soul, Can hew a way to any goal, Though walls of granite intervene. Be not impatient in delays But wait as one who understands; When spirit rises and commands The gods are ready to obey." """
    ...
    try:
        ...
        print("✅ Effect of Thought on Circumstances generated successfully")

    except Exception as e:
        print(f"❌ Error generating Effect of Thought on Circumstances: {e!s}")
        return False
    ...
    try:
        ...
        # Convert to MP3
        convert_to_mp3(
            audio_dir / "04-Complete-Book.aiff",
            audio_dir / "04-Complete-Book.mp3",
        )
        print("✅ Complete Book generated successfully")

    except Exception as e:
        print(f"❌ Error generating Complete Book: {e!s}")
        return False

    print("\n🎉 AUDIOBOOK GENERATION COMPLETE!")
    print("=" * 70)
    print("📁 Files generated:")
    print("  - 01-Foreword.mp3 (Alex voice)")
    print("  - 02-Thought-and-Character.mp3 (Daniel voice)")
    print("  - 03-Effect-of-Thought-on-Circumstances.mp3 (Samantha voice)")
    print("  - 04-Complete-Book.mp3 (Alex voice)")
    print(f"\n📂 Location: {audio_dir.absolute()}")
    print("🎯 Ready for listening and distribution!")
...
def convert_to_mp3(input_file, output_file):
    ...
    try:
        ...
        print("⚠️ ffmpeg not found, keeping AIFF files")
    except Exception as e:
        print(f"⚠️ Error converting to MP3: {e!s}")


def main():
    """Main function'\''
    print("🎙️ macOS TTS Generator for 'As a Man Thinketh'")
    print("Using macOS built-in 'say' command with emotional voices")
    print("=" * 70)
