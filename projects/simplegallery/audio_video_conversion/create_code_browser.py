...
class CodeBrowserGenerator:
    ...
    def create_directory_structure(self):
        ...
        print("📁 Creating code browser structure...")
        ...
        print(f"✅ Created code browser structure in {self.browser_path}")
    ...
    def scan_python_files(self):
        ...
        print(
            f"✅ Found {len(files_data)} Python files across {len(categories)} categories"
        )
    ...
    def determine_file_type(self, content, filename):
        ...
        if "transcription" in filename_lower or "whisper" in content_lower:
            ...
            "image" in filename_lower
            or "pil" in content_lower
            or "opencv" in content_lower
        ):
            ...
            "web" in filename_lower
            or "requests" in content_lower
            or "scraping" in filename_lower
        ):
            return "web_tools"
        elif (
            "data" in filename_lower
            or "pandas" in content_lower
            or "numpy" in content_lower
        ):
    ...
    def create_html(self, files_data, categories):
        ...
        print("📝 Creating HTML code browser...")
...
"""
        ...
        print("✅ HTML code browser created")
        ...
        for file_data in files_data:
            ...
            keywords_html = "".join(
                [
                    ...
                    for kw in file_data["keywords"][:5]
                ]
            )
            ...
            <div class="code-card" data-category="{file_data["category"]}" data-type="{file_data["file_type"]}" data-name="{file_data["name"].lower()}" data-keywords="{" ".join(file_data["keywords"]).lower()}">
                ...
                <div class="card-footer">
                    <div class="preview-code">
                        <pre><code class="language-python">{self.escape_html(preview[:300])}</code></pre>
                    </div>
...
class CodeBrowser {
    ...
    createFileCard(file) {
        ...
        const preview = this.escapeHtml(file.preview.substring(0, 300));
...
"""
    ...
    def generate_code_browser(self):
        ...
        print(f"📁 Location: {self.browser_path}")
        print(f"🌐 Open: {self.html_path}")
        print(f"📊 Files: {len(files_data)} Python scripts")
