            ...
            analysis["content_analysis"]["ai_art_projects"].append(
                {
                    ...
                    "indicators": self._extract_keywords(
                        content_lower,
                        ["ai", "art", "image", "generation", "prompt"],
                    ),
                },
            )
            ...
            analysis["content_analysis"]["video_projects"].append(
                {
                    ...
                    "indicators": self._extract_keywords(
                        content_lower,
                        ["video", "editing", "production", "capcut"],
                    ),
                },
            )
            ...
            analysis["content_analysis"]["web_projects"].append(
                {
                    ...
                    "indicators": self._extract_keywords(
                        content_lower,
                        ["html", "css", "javascript", "website", "web"],
                    ),
                },
            )
            ...
            analysis["content_analysis"]["documentation"].append(
                {
                    ...
                    "indicators": self._extract_keywords(
                        content_lower,
                        ["documentation", "guide", "manual", "readme"],
                    ),
                },
            )
    ...
    <div class="container">
        ...
        <div class="directory-card">
            ...
            for skill, count in sorted(
                analysis["skill_indicators"].items(),
                key=lambda x: x[1],
                reverse=True,
            ):
                if count > 0:
