...
class AssemblyAITTS(TTSProvider):
    ...
    def synthesize(self, text: str, output_path: str, voice: str = None) -> bool:
        ...
        try:
            ...
            data = {"text": text, "voice": voice or "alloy"}
            ...
            print(f"AssemblyAI TTS Error: {e}")
            return False
...
class AsAManThinkethTTS:
    ...
    def setup_tts_provider(self):
        ...
        print(f"Using TTS provider: {self.provider_name}")
    ...
    def synthesize_all(self, voice: str = None) -> bool:
        ...
        print(f"Starting synthesis of all chapters using {self.provider_name}...")
    ...
    def list_chapters(self):
        ...
        for key, chapter in self.chapters.items():
            print(f"  {key}: {chapter['title']}")

    def interactive_mode(self):
        """Interactive mode for chapter selection"""
        while True:
            print("\n" + "=" * 50)
            print("As a Man Thinketh - Text to Speech System")
            print("=" * 50)
            print("1. List chapters")
            print("2. Synthesize specific chapter")
            print("3. Synthesize all chapters")
            print("4. Exit")
    ...
    try:
        ...
        if len(sys.argv) > 1:
            ...
            if command == "list":
                ...
                print(
                    "Usage: python as_a_man_thinketh_tts_real.py [list|all|<chapter_key>]"
                )
        else:
