...
class ContentAwareAnalyzer:
    ...
    def scan_all_files(self):
        ...
        print("🔍 Performing content-aware analysis of all files...")
        ...
        for file_info in self.all_files:
            for code_block in file_info.get('code_blocks', []):
                ...
                try:
                    ...
                    print(f"   ✅ Extracted: {code_type}/{filename}")
                except Exception as e:
    ...
    def generate_project_reports(self):
        ...
        for project, files in self.analysis_results['project_identifications'].items():
            report_path = self.target_dir / '01_Projects' / self.sanitize_filename(project, 50) / f"{self.sanitize_filename(project, 30)}_ANALYSIS.md"
        ...
        with open(relationship_report_path, 'w', encoding='utf-8') as f:
            ...
            for file_id, relationships in self.analysis_results['file_relationships'].items():
                ...
                for rel in relationships['related_files']:
                    f.write(f"  - {rel['file_id']} (Projects: {', '.join(rel['shared_projects'])}, Topics: {', '.join(rel['shared_topics'])})\\n")
                f.write("\\n")
    ...
    def export_analysis_data(self):
        ...
        print(f"   ✅ Analysis data exported: {json_path}")
    
    def run_complete_analysis(self):
        """Run the complete content-aware analysis"""
        print("🚀 Starting Content-Aware Chat Analysis...")
        ...
        print(f"📋 Check MASTER_ANALYSIS_REPORT.md for overview")

def main():
    """Main execution function"""
    source_dir = "/Users/steven/Documents/cursor-agent/chat_analysis "
    target_dir = "/Users/steven/CONTENT_AWARE_CHAT_ANALYSIS"
