...
class SimpleDrAduReader:
    def __init__(self, source_dir, target_dir):
        ...
        self.search_terms = [
            ...
            'gainesvillepfs', 'Dr Adu', 'Lawrence Adu'
        ]
            ...
            if file_path.is_file() and file_path.suffix in ['.md', '.html', '.txt', '.json']:
                ...
                try:
                    ...
                    if relevance_score > 0:
                        ...
                        print(f"      ✅ Found relevant content (score: {relevance_score})")
    ...
    def calculate_relevance_score(self, content):
        ...
        high_priority = [
            'dr. adu', 'dr lawrence adu', 'lawrence adu',
            'gainesville psychiatry and forensic services',
            'gainesvillepfs.com', 'gainesvillepfs'
        ]
        
        # Medium priority terms
        medium_priority = [
            'gainesville psychiatry', 'tms therapy',
            'forensic psychiatry', 'psychiatrist gainesville',
            'seo optimization', 'mental health services'
        ]
        
        # Low priority terms
        low_priority = [
            'psychiatry', 'gainesville', 'seo', 'optimization',
            'mental health', 'therapy', 'psychiatrist'
        ]
    ...
    def run_analysis(self):
        ...
        print(f"📋 Check MASTER_INDEX.md for navigation")
