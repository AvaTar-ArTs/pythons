...
class RevenueDashboard:
    ...
    def add_revenue_goal(self, name: str, target_amount: float, deadline: str, system: str) -> str:
        ...
        try:
            ...
            cursor.execute('''
                ...
                VALUES (?, ?, ?, ?, ?, ?, ?, ?)
            ''', (
                goal_id, name, target_amount, 0.0, deadline, system,
    ...
    def update_revenue(self, system: str, amount: float, platform: str = "direct") -> bool:
        ...
        try:
            ...
            cursor.execute('''
                ...
                VALUES (?, ?, ?, ?, ?, ?, ?)
            ''', (
                metric_id, "revenue", amount, datetime.datetime.now().date().isoformat(),
                system, platform, datetime.datetime.now().isoformat()
            ))
...
def main():
    ...
    try:
        ...
        # Add sample goals
        dashboard.add_revenue_goal("Monthly $10K", 10000, "2024-12-31", "ai_recipe_generator")
        dashboard.add_revenue_goal("Weekly $2.5K", 2500, "2024-12-31", "ai_receptionist")
