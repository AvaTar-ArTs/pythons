...
def get_thematic_category(song_name):
    ...
    elif any(pattern in song_lower for pattern in ["trash", "raccoon", "raccoon", "trashcat", "raccoon"]):
    ...
    elif any(pattern in song_lower for pattern in ["suno"]):
        return "Suno_Exports"
...
def organize_directory_contents():
    ...
    for item in all_items:
        ...
        if item.is_file():
            ...
            if any(keyword in dir_name for keyword in ["suno", "export", "json"]):
                ...
                # For other directories, look at their content to determine category
    ...
    with open(summary_path, "w") as f:
        ...
        f.write("- **Directories moved**: 0 (directories were already processed)\n")
