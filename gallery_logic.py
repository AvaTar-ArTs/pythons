...
from simplegallery.logic.variants.google_gallery_logic import \
    GoogleGalleryLogic
from simplegallery.logic.variants.onedrive_gallery_logic import \
