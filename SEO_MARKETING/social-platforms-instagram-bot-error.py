...
def functionLike(mySystem):
    ...
    def like(likes=1):
        ...
        logger.info(
            rf"Number of photos liked: \CONSTANT_33[0;33m{item - 1}\CONSTANT_33[m",
        )
...
def functionDraw(mySystem):
    ...
    def commentDraw(amount=1, comment=""):
        ...
        logger.info(rf"Number of commented: \CONSTANT_33[0;33m{item - 1}\CONSTANT_33[m")
...
while True:
    ...
    logger.info("")
    logger.info(r"\CONSTANT_33[0;33m(to finish press Ctrl + C)\CONSTANT_33[m")
