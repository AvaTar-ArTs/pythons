...
class Instagram:
    ...
    def topluYorumYapma(self, url=None, yorumSayisi=None, secilenIslem=None):
        ...
        try:
            if url is None:
                ...
                logger.info(
                    str(self.configGetir(base_warnings + "warning1")).format(url=url)
                )
            ...
            if secilenIslem == "1":
                ...
                logger.info(
                    str(self.configGetir(base_warnings + "warning8")).format(url=url)
                )
            ...
            logger.info(
                str(self.configGetir(base_warnings + "warning14")).format(url=url)
            )
            self.topluYorumYapma()
        except Exception as error:
            self.uyariOlustur(
    ...
    def oneCikanHikayeIndir(self):
        ...
        try:
            ...
            self.klasorDegistir("../")
            logger.info(
                str(self.configGetir(base_warnings + "warning4")).format(url=url)
            )
            self.oneCikanHikayeIndir()
        except Exception as error:
            self.uyariOlustur(
    ...
    def gonderiYorumYapma(self, url=None, yorum=None):
        ...
        try:
            ...
            if not self.hesapGizliMi():
                ...
                self.yorumYap(yorum)
                logger.info(
                    str(self.configGetir(base_warnings + "warning5")).format(url=url)
                )
            else:
                self.uyariOlustur(
    ...
    def klasorOlustur(self, klasor):
        ...
        logger.info(
            str(self.configGetir(base_warnings + "warning3")).format(klasor=klasor)
        )
