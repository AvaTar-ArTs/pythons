...
class NetlifyUploader(BaseUploader):
    # Netlify OAuth credentials — set via environment variables:
    #   export NETLIFY_CLIENT_ID="your-client-id"
    #   export NETLIFY_CLIENT_SECRET="your-client-secret"
    client_id = os.environ.get("NETLIFY_CLIENT_ID", "")
    client_secret = os.environ.get("NETLIFY_CLIENT_SECRET", "")
