...
def functionLike(mySystem):
    ...
    def like(likes=1):
        ...
        logger.info(
            f"Number of photos liked: \CONSTANT_33[0;33m{item - 1}\CONSTANT_33[m"
        )
...
def functionComment(mySystem):
    ...
    def likecomment(likes=1, comment=""):
        ...
        logger.info(
            f"Number of photos liked and commented: \CONSTANT_33[0;33m{item - 1}\CONSTANT_33[m"
        )
    ...
    def stories():
        ...
        while loadstories != 0:
            ...
            try:
                ...
                logger.info(
                    "\CONSTANT_33[0;33mEND! No more stories to view\CONSTANT_33[m"
                )
                loadstories = 0
...
while True:
    ...
    for indice, lista in enumerate(
        ...
        logger.info(
            f"\CONSTANT_33[0;34m[{indice}]\CONSTANT_33[m {lista}"
