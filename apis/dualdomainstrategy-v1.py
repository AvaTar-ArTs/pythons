...
def main():
    ...
    with open(
        str(Path.home()) + "/Documents/python/implementation_roadmap.json", "w"
    ) as f:
    ...
    with open(
        str(Path.home()) + "/Documents/python/content_automation_system.py", "w"
    ) as f:
        f.write(content_system)

    with open(
        str(Path.home()) + "/Documents/python/seo_optimization_tools.py", "w"
    ) as f:
        f.write(seo_tools)
