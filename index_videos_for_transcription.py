...
VIDEO_EXTENSIONS = {'.mp4', '.MP4', '.mkv', '.MKV', '.mov', '.MOV', '.avi', '.AVI', '.m4v', '.M4V'}
...
def get_video_files(directories):
    ...
    for directory in directories:
        ...
        for root, dirs, files in os.walk(directory):
            ...
            dirs[:] = [d for d in dirs if not d.startswith('.') and d not in ['node_modules', '__pycache__', '.git', 'audio_temp']]
...
def main():
    ...
    fieldnames = [
        ...
        'size_mb', 'has_transcript', 'has_analysis',
    ...
    print()
    print(f"To process all files needing work:")
    print(f"  python3 /Users/steven/Movies/video_analysis_workflow.py $(cat {needs_work_csv} | cut -d',' -f1 | tail -n +2)")
    print()
