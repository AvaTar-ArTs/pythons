...
class PythonCodebaseOrganizer:
    ...
    def __init__(self, root_dir: str):
        ...
        self.pattern_rules = {
            'youtube': {
                'keywords': ['youtube', 'yt_', 'video', 'download', 'playlist', 'channel'],
                'imports': ['youtube_dl', 'pytube', 'googleapiclient'],
                'functions': ['download', 'extract', 'get_video', 'playlist']
            },
            'ai': {
                'keywords': ['whisper', 'openai', 'dalle', 'gpt', 'ai_', 'transcribe', 'tts'],
            ...
            'web': {
                'keywords': ['scrape', 'requests', 'beautifulsoup', 'selenium', 'instagram'],
    ...
    def _calculate_metrics(self) -> Dict[str, Any]:
        ...
        return {
            ...
            'documentation_rate': (files_with_docs / valid_files * 100) if valid_files > 0 else 0,
            'total_lines': total_lines,
            'total_functions': total_functions,
            'total_classes': total_classes,
            'average_functions_per_file': total_functions / valid_files if valid_files > 0 else 0,
            'average_classes_per_file': total_classes / valid_files if valid_files > 0 else 0,
    ...
    def _generate_readme(self) -> str:
        ...
        readme += "This directory contains an organized version of the Python codebase.\n\n"
