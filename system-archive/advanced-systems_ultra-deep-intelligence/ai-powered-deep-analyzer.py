...
class AIDeepIntelligentAnalyzer:
        ...
        try:
            ...
            if metadata['loc'] > 10 and metadata['loc'] < 1000:  # Reasonable size
                if self.stats['ai_analyzed'] < 100:  # Limit AI calls
                    print(f"{Colors.CYAN}{Emojis.BRAIN} AI analyzing: {filepath.name}{Colors.END}")
    ...
    def scan_directory(self, directory: str, current_depth: int = 0):
        ...
        try:
            ...
            print(f"{Colors.CYAN}{Emojis.FOLDER} Scanning: {directory} (depth: {current_depth}/{self.max_depth}){Colors.END}")
    ...
    def analyze_duplicates(self):
        ...
        print(f"{Colors.GREEN}{Emojis.CHECK} Exact Duplicates: {len(exact_dupes)} groups{Colors.END}")
        print(f"{Colors.BLUE}   Duplicate files: {self.stats['exact_dupes']}{Colors.END}")
        ...
        print(f"{Colors.GREEN}{Emojis.CHECK} Semantic Groups: {self.stats['semantic_dupes']}{Colors.END}")
    ...
    def create_detailed_report(self, exact_dupes: Dict, semantic_dupes: Dict):
        ...
        with open(report_file, 'w', encoding='utf-8') as report:
            ...
            report.write(f"| **Total Size** | {self.stats['total_size'] / (1024**3):.2f} GB |\n")
    ...
    def run_complete_analysis(self):
        ...
        print("╔═══════════════════════════════════════════════════════════════════════════════╗")
        print("║                                                                               ║")
        print("║           🧠 AI-POWERED DEEP INTELLIGENT ANALYZER 🚀                          ║")
        print("║                                                                               ║")
        print("║        Advanced AI-Driven Code Analysis & Pattern Recognition System         ║")
        print("║                                                                               ║")
        print("╚═══════════════════════════════════════════════════════════════════════════════╝")
        print(f"{Colors.END}\n")
        ...
        print(f"{Colors.YELLOW}{Emojis.GEAR} Max Depth: {self.max_depth} levels{Colors.END}\n")
        ...
        print(f"  {Emojis.FILE} Files: {Colors.CYAN}{self.stats['total_files']:,}{Colors.END}")
        print(f"  {Emojis.PYTHON} Python: {Colors.CYAN}{self.stats['py_files']:,}{Colors.END}")
        print(f"  {Emojis.BRAIN} AI Analyzed: {Colors.CYAN}{self.stats['ai_analyzed']:,}{Colors.END}")
        print(f"  {Emojis.FIRE} Patterns: {Colors.CYAN}{self.stats['patterns_detected']:,}{Colors.END}")
        print(f"  💾 Size: {Colors.CYAN}{self.stats['total_size'] / (1024**3):.2f} GB{Colors.END}\n")
