...
class PicturesOrganizer:
    ...
    def analyze_and_categorize(self):
        ...
        for item in self.pictures_dir.iterdir():
            ...
            if item.suffix.lower() not in ['.jpg', '.jpeg', '.png', '.gif', '.webp', '.svg', '.bmp']:
                continue
            ...
            elif 'chart' in name_lower or 'graph' in name_lower or 'analyze' in name_lower:
                dest = categories['charts_graphs']
            elif 'screenshot' in name_lower or 'aws' in name_lower or 'lambda' in name_lower:
        ...
        print(f"  ✅ Categorized {sum(len(files) for files in self.organized.values())} files\n")
    ...
    def generate_report(self):
        ...
        with open(report_path, 'w') as f:
            ...
            total_size = sum(sum(size for _, size in files) for files in self.organized.values())
