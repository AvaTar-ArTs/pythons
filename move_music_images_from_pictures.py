...
def move_music_images():
    ...
    for img_path in music_images:
        ...
        if "alley" in img_name or "in.the.alley" in img_name or "in_the_alley" in img_name:
            target_dir = target_base / "ALBUMS" / "In_This_Alley_Where_I_Hide"
        elif "willow" in img_name or "willow.whispers" in img_name or "willow_whispers" in img_name:
            target_dir = target_base / "ALBUMS" / "Willow_Whispers"
        elif "summer" in img_name or "summer.love" in img_name or "summer_love" in img_name:
            target_dir = target_base / "ALBUMS" / "Summer_Love"
        elif "hero" in img_name or "heroes" in img_name or "villains" in img_name:
            target_dir = target_base / "ALBUMS" / "Heroes_Rise_Villains_Overthrow"
        elif "junkyard" in img_name or "trashcat" in img_name or "raccoon" in img_name:
