...
class EnhancedContentAnalyzerV2:
    def __init__(self, source_dir, target_dir, batch_size=5):
        ...
        self.dr_adu_terms = [
            'Dr. Adu', 'Dr Lawrence Adu', 'Lawrence Adu',
            'Gainesville Psychiatry', 'gainesvillepfs.com',
            'Gainesville Psychiatry and Forensic Services',
            'TMS therapy', 'forensic psychiatry',
            'SEO optimization', 'psychiatrist Gainesville',
            'NeuroStar', 'treatment-resistant depression',
    ...
    def extract_tool_calls(self, content, max_calls=8):
        ...
        for tool_content in tool_matches[:max_calls]:
            ...
            tool_info = {
                ...
                'tool_id': tool_id,
                'size': size,
                'content_preview': tool_content[:300] + "..." if len(tool_content) > 300 else tool_content,
    ...
    def categorize_content(self, content, filename):
        ...
        patterns = {
            'seo_optimization': [
                ...
                r'structured data', r'schema\.org', r'google my business'
            ],
            'web_development': [
            ...
            'dr_adu_psychiatry': [
                r'Dr\.?\s*Adu', r'Lawrence\s*Adu', r'Gainesville\s*Psychiatry',
                r'forensic\s*psychiatry', r'TMS\s*therapy', r'NeuroStar',
                r'treatment-resistant\s*depression', r'mental\s*health\s*services',
                r'psychiatrist\s*Gainesville', r'gainesvillepfs\.com'
            ]
        }
    ...
    def calculate_file_quality(self, file_info):
        ...
        if 1000 <= file_info['word_count'] <= 15000:
            score += 0.1
        elif file_info['word_count'] > 15000:
            score += 0.05
    ...
    def assess_business_value(self, file_info):
        ...
        if any(cat in file_info['categories'] for cat in ['seo_optimization', 'business_development', 'dr_adu_psychiatry']):
            value = 'high'
    ...
    def generate_enhanced_batch_insights(self, batch_results):
        ...
        if batch_results['dr_adu_files']:
            insights['dr_adu_insights'].append(f"Identified {len(batch_results['dr_adu_files'])} files with Dr. Adu content")
    ...
    def scan_all_files_batched(self):
        ...
        print("🔍 Performing enhanced content-aware analysis with Dr. Adu focus...")
...
"""
    ...
    def run_enhanced_analysis(self):
        ...
        print("🚀 Starting Enhanced Content-Aware Analysis v2.0...")
        print("📊 This will generate professional-grade analysis reports with Dr. Adu focus")
        ...
        print(f"📋 Check ENHANCED_MASTER_ANALYSIS_V2.md for comprehensive overview")
        print(f"📦 Individual batch reports in: 07_Exports/batches/")
        print(f"🏥 Dr. Adu practice content in: 08_Dr_Adu_Content/")
        print(f"🔍 SEO optimization content in: 09_SEO_Optimization/")

def main():
    """Main execution function"""
    source_dir = "/Users/steven/Documents/cursor-agent/chat_analysis /markdown_reports"
    target_dir = "/Users/steven/tehSiTes/Dr_Adu_GainesvillePFS_SEO_Project"
