...
class APIDiscoveryEngine:
    ...
    def _categorize_discovered_apis(self):
        ...
        # Category patterns
        categories = {
            'llm': ['OPENAI', 'ANTHROPIC', 'GOOGLE', 'GEMINI', 'DEEPSEEK', 'MISTRAL', 
                    'GROQ', 'CEREBRAS', 'COHERE', 'FIREWORKS', 'TOGETHER', 'PERPLEXITY', 
                    'OPENROUTER', 'CLAUDE'],
            
            'image': ['LEONARDO', 'STABILITY', 'REPLICATE', 'FAL', 'RUNWAY', 
                      'IMAGGA', 'REMOVEBG', 'VANCEAI', 'DALLE', 'MIDJOURNEY'],
            
            'audio': ['ELEVENLABS', 'DEEPGRAM', 'ASSEMBLYAI', 'MURF', 'RESEMBLE', 
                      'REVAI', 'DESCRIPT', 'WHISPER', 'SUNO', 'UDIO'],
            
            'video': ['RUNWAY', 'SORA', 'HEYGEN', 'STABLE_VIDEO_DIFFUSION', 
                      'PIKA', 'SYNTHESIA'],
            
            'analytics': ['NEWSAPI', 'SERPAPI', 'SCRAPINGBEE', 'SCRAPINGBOT', 
                          'BRIGHTDATA', 'APIFY'],
            
            'automation': ['ZAPIER', 'MAKE', 'N8N', 'INTEGROMAT'],
            
            'vector_db': ['PINECONE', 'QDRANT', 'CHROMADB', 'ZEP', 'LLAMAINDEX', 
                          'WEAVIATE', 'MILVUS'],
