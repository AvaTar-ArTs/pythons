...
# Find all MP3 files (only files, not directories)
all_mp3_files = []
for item in source_directory.rglob("*.mp3"):
    if item.is_file():  # Only include actual files, not directories
        all_mp3_files.append(item)
