...
### Added (2026-05-15)
- **CLI scripts merged from notebooklm-skill** — 14 new utility scripts for NotebookLM automation:
  - `ask_question.py`, `batch_query.py`, `conversation_logger.py` — query & logging
  - `export_manager.py`, `profile_manager.py` — data management
  - `source_csv_extractor_v2/v3/v4.py`, `source_diagnostic.py`, `source_extractor.py`, `source_live_observer.py`, `source_simple_reader.py` — source extraction tools
  - `query_history.py` — conversation history
- **Static site generator** — `scripts/generate_notebooklm_static_site.py` generates versioned HTML mini-sites from NotebookLM exports
- **Site examples** — `docs/examples/site/` with sample output from the static site generator
