...
if not client.api_key:
    print(
        colored("❌ Error: OPENAI_API_KEY not found in environment variables.", "red")
    )
    print(
        "Please ensure your environment is loaded correctly, e.g., by running 'source ~/.env.d/loader.sh llm-apis'"
    )
    sys.exit(1)
