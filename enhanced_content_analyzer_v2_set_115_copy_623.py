    ...
    def extract_tool_calls(self, content, max_calls=8):
        ...
        for tool_content in tool_matches[:max_calls]:
            ...
            tool_info = {
                ...
                "tool_id": tool_id,
                "size": size,
                "content_preview": tool_content[:300] + "..."
...
"""
    ...
    def run_enhanced_analysis(self):
        ...
        print("📋 Check ENHANCED_MASTER_ANALYSIS_V2.md for comprehensive overview")
        print("📦 Individual batch reports in: 07_Exports/batches/")
        print("🏥 Dr. Adu practice content in: 08_Dr_Adu_Content/")
        print("🔍 SEO optimization content in: 09_SEO_Optimization/")
