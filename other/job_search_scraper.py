    ...
    def search_company_careers(self, company_name: str, careers_url: str) -> List[Dict]:
        ...
        try:
            ...
            job_listings = soup.find_all(
                ...
                and any(
                    term in str(x).lower()
                    for term in ["job", "position", "role", "opening", "career"]
                ),
            )
            ...
            for job in job_listings[:10]:  # Limit to first 10
                ...
                if title_elem:
                    ...
                    if any(
                        ...
                        link = (
                            title_elem.get("href", "") if title_elem.name == "a" else ""
                        )
                        ...
                        jobs.append(
                            {
                                "company": company_name,
                                "title": title,
                                "url": link_elem.get("href", lever_url)
                                if link_elem
                                else lever_url,
                                "source": "Lever",
                                "found_date": datetime.now().strftime("%Y-%m-%d"),
...
def main():
    ...
    # AI Music Companies
    companies = [
        {"name": "Suno", "url": "https://jobs.ashbyhq.com/suno", "type": "ashby"},
        {"name": "Runway ML", "url": "https://runwayml.com/careers", "type": "careers"},
        {
            "name": "ElevenLabs",
        ...
        {"name": "Splice", "url": "https://splice.com/careers", "type": "careers"},
        {
            "name": "Leonardo.AI",
