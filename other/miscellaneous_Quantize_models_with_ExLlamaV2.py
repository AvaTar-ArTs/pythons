...
# coding: utf-8
"""
Summary of miscellaneous_Quantize_models_with_ExLlamaV2.py
...
# Download dataset
get_ipython().system('wget https://huggingface.co/datasets/wikitext/resolve/9a9e482b5987f9d25b3a9b2883fc6cc9fd8071b3/wikitext-103-v1/wikitext-test.parquet')
...
get_ipython().system('python exllamav2/convert.py      -i base_model      -o quant      -c wikitext-test.parquet      -b {BPW}')
...
get_ipython().system("rsync -av --exclude='*.safetensors' --exclude='.*' ./base_model/ ./quant/")
