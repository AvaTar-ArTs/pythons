...
# coding: utf-8
"""
Summary of miscellaneous_Fine_tune_Llama_2_in_Google_Colab.py
...
get_ipython().system('pip install -q accelerate==0.21.0 peft==0.4.0 bitsandbytes==0.40.2 transformers==4.31.0 trl==0.4.7')
