...
class SphinxDocsGenerator:
    ...
    def create_full_documentation(self):
        ...
        print(f"📂 View at: file://{self.docs_dir.absolute() / '_build/html/index.html'}")
...
'''
    ...
    def _build_html(self):
        ...
        try:
            ...
            subprocess.run(['pip3', 'install', 'sphinx', 'sphinx_rtd_theme'], 
                         capture_output=True)
            
            # Build HTML
            result = subprocess.run(
                ['sphinx-build', '-b', 'html', str(self.docs_dir), 
