...
df_vids = pd.read_csv("/Users/steven/clean-organizer/vids-03-29-17:53.csv")
df_other = pd.read_csv("/Users/steven/clean-organizer/other-03-29-17:52.csv")
df_img = pd.read_csv("/Users/steven/clean-organizer/image_data-03-29-17:51.csv")
df_docs = pd.read_csv("/Users/steven/clean-organizer/docs-03-29-17:49.csv")
df_audio = pd.read_csv("/Users/steven/clean-organizer/audio-03-29-17:49.csv")

# --------------------------------------------------------------------------------
# 2) Basic analysis: shapes, duplicated counts, and a few lines to see structure
# --------------------------------------------------------------------------------
...
for df_clean in [
    ...
    if "creation_date" in df_clean.columns:
        df_clean["creation_date"] = pd.to_datetime(
            df_clean["creation_date"], errors="coerce"
        )
...
df_vids_clean.to_csv("/Users/steven/clean-organizer/vids_cleaned.csv", index=False)
df_other_clean.to_csv("/Users/steven/clean-organizer/other_cleaned.csv", index=False)
df_img_clean.to_csv("/Users/steven/clean-organizer/image_data_cleaned.csv", index=False)
df_docs_clean.to_csv("/Users/steven/clean-organizer/docs_cleaned.csv", index=False)
df_audio_clean.to_csv("/Users/steven/clean-organizer/audio_cleaned.csv", index=False)
