...
class AnalysisMerger:
    ...
    def load_enhanced_analysis(self, filename: str = "comprehensive_files_to_remove.csv"):
    ...
    def load_content_analysis(self, filename: str = "content_based_duplicates_to_remove.csv"):
        ...
        for filepath in all_files:
            ...
            if content and enhanced:
                ...
                merged.append({
                    ...
                    'duplicate_type': enhanced.get('duplicate_type', 'content_similarity'),
                    'reason': f"Both methods agree: {content['reason']}",
                    'file_size': content.get('file_size', enhanced.get('file_size', 0)),
                ...
                merged.append({
                    ...
                    'secondary_confidence': 'N/A',
                    'duplicate_type': enhanced.get('duplicate_type', 'filename_pattern'),
    ...
    def save_merged_results(self, output_file: str = "merged_analysis_results.csv"):
        ...
        with open(output_file, 'w', newline='', encoding='utf-8') as f:
            fieldnames = [
                ...
                'confidence_score', 'primary_method', 'secondary_method',
                'primary_confidence', 'secondary_confidence', 'duplicate_type',
                'reason', 'file_size', 'functions', 'classes', 'agreement'
            ]
    ...
    def generate_summary(self):
        ...
        print(f"\n🤝 Method Agreement:")
        for agreement, count in sorted(agreement_counts.items(), key=lambda x: x[1], reverse=True):
            pct = (count / len(self.merged_recommendations)) * 100
        ...
        for i, rec in enumerate(self.merged_recommendations[:10], 1):
            ...
            print(f"   {i:2}. [{rec['confidence']:10}] {rec['similarity_score']} - {filename}")
