...
for f in loose_files:
    ...
    elif 'divine' in name or 'mastery' in name or 'poem' in name or 'universal' in name or 'power' in name:
...
# Move old folders
old_folders = [d for d in BASE.iterdir() if d.is_dir() and not d.name.startswith(('1_', '2_', '3_', '4_', '5_', '6_', '7_', '8_'))]
