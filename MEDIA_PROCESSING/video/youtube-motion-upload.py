"""
Summary of youtube-motion-upload.py
...
image_file_path = Path(
    str(Path.home())
    + "/Pictures/zombot/default_a_detailed_photograph_of_a_serious_cyberpunk_zombot_cy_0_fb6f4194-86a6-4f09-be49-57de04fc667a_unzoom.jpg"
)
