...
def main():
    ...
    parser = argparse.ArgumentParser(description='Video Compressor - Reduce video file sizes')
    parser.add_argument('--check', action='store_true', help='Check if ffmpeg is installed')
    parser.add_argument('--generate-script', help='Generate compression script for large videos')
    ...
    print(f"Estimated compression (50-70%): {compressor.format_size(total_size * 0.5)} - {compressor.format_size(total_size * 0.7)} savings")
    print()
