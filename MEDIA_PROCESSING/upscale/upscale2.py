...
def compress_image_to_size(temp_path, final_path, max_size, save_format):
    ...
    while os.path.getsize(temp_path) > max_size and quality > 10:
        ...
        img.save(temp_path, dpi=(300, 300), format=save_format, quality=quality)
        quality -= 5
    ...
    if quality <= 10:
        print(f"Warning: Image compression quality dropped below 10 for {final_path}")
...
for filename in os.listdir(input_dir):
    if filename.lower().endswith((".png", ".jpg", ".jpeg")):
        ...
        # Process the image: upscale by 2x and set DPI to 300
