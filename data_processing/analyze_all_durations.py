...
def main():
    ...
    print("\nUse this to:")
    print("  ? Sort by Content_Type to group similar items")
    print("  ? Filter SHORT_CLIP to find UI sounds/jingles")
    print("  ? Filter SONG to find your music")
    print("  ? Filter PODCAST/STORY and AUDIOBOOK/LONG for spoken content")
    print("  ? Filter UNKNOWN to find items needing duration data")
    print(f"\nOpen: open '{output}'")
