...
class DirectoryMergerOrganizer:
    def __init__(self):
        self.base_directories = [
            ...
            "/Users/steven/MySiTes",
            "/Users/steven/python-docs",
            "/Users/steven/blog-versions",
        ]
        self.output_dir = "/Users/steven/Documents/python/merged_portfolio"
        self.html_output_dir = "/Users/steven/Documents/python/html_portfolio"
...
<body>
    ...
    def run_merge_organization(self):
        ...
        print("📊 Generating file type analysis...")
        ...
        # Save HTML files
        with open(
            os.path.join(self.html_output_dir, "merged_portfolio.html"),
            "w",
            encoding="utf-8",
        ) as f:
        ...
        with open(
            os.path.join(self.html_output_dir, "file_type_analysis.html"),
            "w",
            encoding="utf-8",
        ) as f:
        ...
        # Save JSON catalog
        with open(
            os.path.join(self.output_dir, "content_catalog.json"), "w", encoding="utf-8"
        ) as f:
            json.dump(content_catalog, f, indent=2)

        print("✅ Merge complete!")
        print(f"📁 Merged files: {self.output_dir}")
        print(f"🌐 HTML portfolio: {self.html_output_dir}")
        print(f"📊 Total files processed: {content_catalog['total_files']:,}")
        print(f"📈 Total size: {self._format_size(content_catalog['total_size'])}")
...
def main():
    ...
    for dir_path, dir_info in content_catalog["directories"].items():
        print(
            f"  {dir_info['name']}: {dir_info['file_count']:,} files, {merger._format_size(dir_info['total_size'])}"
        )

    print("\n📈 Top file types:")
    sorted_types = sorted(
        content_catalog["file_types"].items(), key=lambda x: x[1], reverse=True
    )
