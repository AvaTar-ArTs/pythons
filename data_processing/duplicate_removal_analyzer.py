    ...
    def save_results(self, output_file: str = "files_to_remove.csv"):
        ...
        with open(output_file, "w", newline="", encoding="utf-8") as f:
            writer = csv.DictWriter(
                f, fieldnames=["file_to_remove", "keep_file", "reason", "file_size"]
            )
            writer.writeheader()
...
def main():
    ...
    analyzer = DuplicateRemovalAnalyzer(root_dir=args.root, max_files=args.max_files)
