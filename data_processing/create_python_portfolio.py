...
def categorize_project(name, path):
    ...
    if any(
        x in name_lower
        for x in ["transcribe", "transcription", "whisper", "audio", "video"]
    ):
    ...
    if any(
        x in name_lower
        for x in ["instagram", "tiktok", "facebook", "twitter", "social"]
    ):
...
def generate_description(name, category, path):
    ...
    descriptions = {
        "YouTube Automation & Video Generation": {
            "default": "An **automated YouTube tool** for creating and managing video content. This project focuses on streamlining YouTube workflows through automation and AI integration.",
        },
        "AI-Powered Media Processing": {
            "default": "An **AI-powered media processing pipeline** that uses machine learning and automation to process audio and video content.",
        },
        "Social Media Bots": {
            "default": "A **social media automation tool** for managing and automating interactions across various platforms.",
        },
        "E-commerce & Web Automation": {
            "default": "An **e-commerce automation tool** for streamlining online business operations and product management.",
        },
        "Creative Tools & Generative AI": {
            "default": "A **creative AI tool** that combines generative models with artistic workflows to produce unique content.",
        },
        "Web & Gallery Generators": {
            "default": "A **web and gallery generation tool** for creating and managing visual content displays.",
        },
        "Utility & File Management": {
            "default": "A **utility script** for organizing, cleaning, and managing files and directories.",
        },
    }

    # Return a generic description
    return "A **Python automation tool** that streamlines workflows and processes. Part of the AI Alchemy project portfolio, this script exemplifies the fusion of code and creativity to transform complex tasks into automated solutions."
    ...
    for category in category_order:
        if category in projects_by_category:
            ...
            for project in projects_by_category[category][
                :15
            ]:  # Limit to 15 per category in TOC
    ...
    for category in category_order:
        ...
        for project in sorted(projects_by_category[category], key=lambda x: x["name"]):
            ...
            description = generate_description(
                project["name"], category, project["path"]
            )
