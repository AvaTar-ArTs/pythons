...
def compare_catalogs():
    ...
    current_titles = set(
        f["title_lower"] for f in current_files.values() if f["title_lower"]
    )
        ...
        for filename, title, catalog_entry in matched:
            writer.writerow(
                [
                    ...
                    title,
                    "IN_CATALOG",
                    current_files[filename]["duration_formatted"],
                    "Confirmed Suno song",
                ]
            )
