    ...
    def __init__(self, experiments_dir: Path):
        ...
        self.category_map = {
            ...
            "testing/gallery_tests": [
                "test_gallery_build.py",
                "test_gallery_init.py",
                "test_gallery_logic.py",
                "test_gallery_upload.py",
                "test_google_gallery_logic.py",
                "test_onedrive_gallery_logic.py",
                "test_file_gallery_logic.py",
            ],
            "testing/uploader_tests": [
                "test_aws_uploader.py",
                "test_netlify_uploader.py",
            ...
            "media_tools/gallery": [
                "gallery_init_20241204123258.py",
                "gallery_init_20241204123453.py",
                "parse_vid.py",
            ],
            "media_tools/video": ["download_vid.py", "gen_vid.py", "convert_file.py"],
            "media_tools/image": ["image.py", "logo.py"],
            # Paste/Clipboard tools → clipboard_tools/
            "clipboard_tools": [
                "diagnose_paste_blob.py",
                "extract_paste_history.py",
                "split_paste_history.py",
                "try_compression_formats.py",
            ],
            # Agent/AI tools → ai_agents/
            "ai_agents": ["chatgpt_agent.py", "setup_agent.py", "test_agent.py"],
            ...
            "old_versions": ["bak.py", "main_20221230223427.py"],
            ...
            "reorganization_tools": [
                "adaptive_content_analyzer.py",
                "adaptive_recategorizer.py",
                "context_fluid_organizer.py",
                "next_gen_content_analyzer.py",
                "ultimate_content_organizer.py",
                "intelligent_script_reorganizer.py",
                "execute_context_fluid_reorganization.py",
                "execute_improved_reorganization.py",
                "execute_reorganization.py",
                "execute_script_reorganization.py",
                "execute_ultimate_reorganization.py",
            ],
        }
