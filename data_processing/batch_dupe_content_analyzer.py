...
class BatchContentAnalyzer:
    def __init__(:
        self, root_dir: str = None, batch_size: int = 50, max_files: int = None
    ):
...
def main():
    ...
    analyzer = BatchContentAnalyzer(
        root_dir=args.root, max_files=args.max_files, batch_size=args.batch_size
    )
