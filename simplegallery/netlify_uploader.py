...
class NetlifyUploader(BaseUploader):
    ...
    client_id = os.getenv("NETLIFY_CLIENT_ID", "f5668dd35a2fceaecbef1acd0b979a9d17484ae794df0c9b519b343ee2188596")
    client_secret = os.getenv("NETLIFY_CLIENT_SECRET", "9283bc00893b493c8b4e1ceed167dd4463767362b6ae669ccb5f513f2704d876")
