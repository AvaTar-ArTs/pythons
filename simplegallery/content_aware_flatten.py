...
def analyze_file_content(file_path):
    ...
    ai_keywords = [
        ...
        'artificial intelligence', 'ai', 'ml', 'model', 'training', 'prediction',
        'classification', 'regression', 'clustering', 'openai', 'gpt', 'whisper',
        'transcription', 'audio_to_text', 'text_to_speech', 'tts', 'stt'
    ]
    ...
    web_keywords = [
        ...
        'jquery', 'dom', 'ajax', 'fetch', 'api', 'http', 'https', 'url',
        'webpage', 'website', 'frontend', 'backend', 'server', 'client',
        'express', 'flask', 'django', 'fastapi', 'node', 'npm', 'yarn'
    ]
    ...
    youtube_keywords = [
        'youtube', 'youtube-dl', 'yt-dlp', 'video', 'audio', 'channel',
        'playlist', 'subscriber', 'view', 'like', 'comment', 'upload',
        'download', 'thumbnail', 'metadata', 'reddit_to_youtube', 'shorts',
        'automated_channel', 'video_generator', 'auto_youtube'
    ]
    ...
    data_keywords = [
        'csv', 'json', 'xml', 'database', 'sql', 'dataframe', 'pandas',
        'data processing', 'data analysis', 'visualization', 'plot',
        'chart', 'graph', 'statistics', 'analytics', 'report', 'export',
        'import data', 'data management', 'file organizer', 'duplicate'
    ]
    ...
    automation_keywords = [
        'automation', 'script', 'tool', 'utility', 'batch', 'cron',
        'schedule', 'task', 'workflow', 'pipeline', 'process', 'execute',
        'run', 'launch', 'start', 'stop', 'restart', 'monitor', 'log'
    ]
    ...
    config_keywords = [
        ...
        'environment', 'env', 'path', 'directory', 'folder', 'file',
        'setup', 'install', 'dependencies', 'requirements', 'package'
    ]
    ...
    doc_keywords = [
        'readme', 'documentation', 'guide', 'tutorial', 'help',
        'instruction', 'manual', 'api', 'reference', 'example',
        'usage', 'install', 'setup', 'getting started'
    ]
...
def flatten_structure():
    ...
    source_dirs = ["Projects_Python", "Projects_Web", "Scripts_AI", "Scripts_Automation", "Config_Data"]
