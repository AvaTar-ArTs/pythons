...
class EmotionalQuizGenerator:
    ...
    def generate_emotional_quiz_speech(self, question, options, correct_answer, output_path, emotion="excited", voice="alloy"):
        """
        ...
        print(f"🎭 Generating {emotion} quiz: {question[:40]}...")
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                print(f"✅ Generated emotional quiz: {os.path.basename(output_path)}")
                return True
            else:
...
def main():
    ...
    print("🎭 AlchemyAPI Emotional Quiz Generator")
    print("=" * 60)
    ...
    output_folder = "/Users/steven/tehSiTes/AlchemyAPI/emotional_quiz_mp3s"
    ...
    try:
        ...
        for emotion, files in emotion_groups.items():
            ...
            for file_info in files:
                print(f"  🎵 {file_info['voice']}: {file_info['file']}")
                print(f"     Q: {file_info['question'][:50]}...")
                print(f"     A: {file_info['correct_answer']}")
