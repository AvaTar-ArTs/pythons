...
def create_sample_gallery(gallery_path="."):
    ...
    os.makedirs(os.path.join(gallery_path, "public", "images", "thumbnails"), exist_ok=True)
...
def main():
    """Main setup function"""
    parser = argparse.ArgumentParser(description="Setup SimpleGallery Enhanced Features")
