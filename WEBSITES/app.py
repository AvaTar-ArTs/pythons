...
def webhook():
    ...
    try:
        ...
        # Greeting
        response.say(
            "Thank you for calling Heavenly Hands Cleaning Services. How can we help you today?"
        )

        # Gather input
        gather = response.gather(
            num_digits=1, action="/handle-input", method="POST", timeout=10
        )
        gather.say(
            "Press 1 for residential cleaning, 2 for commercial cleaning, or 3 to speak with a representative."
        )
...
def handle_input():
    ...
    try:
        ...
        if digits == "1":
            response.say(
                "You selected residential cleaning. Please hold while we connect you to our residential cleaning specialist."
            )
            # Here you would transfer to a specific number or queue
        elif digits == "2":
            response.say(
                "You selected commercial cleaning. Please hold while we connect you to our commercial cleaning specialist."
            )
            # Here you would transfer to a specific number or queue
        elif digits == "3":
