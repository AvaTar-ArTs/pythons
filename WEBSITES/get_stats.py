...
def get_stats():
    ...
    today_count = sum(1 for f in txt_files if datetime.fromtimestamp(f.stat().st_mtime).date() == today)
    ...
    items = [
        {
            ...
            "icon": {"path": "/System/Library/CoreServices/CoreTypes.bundle/Contents/Resources/ProfileBackgroundColor.icns"}
        },
        {
            ...
            "arg": str(CONVERSATIONS_DIR),
            "valid": True,
            "icon": {"path": "/System/Library/CoreServices/CoreTypes.bundle/Contents/Resources/Clock.icns"}
        },
        {
            "title": f"📝 {len(txt_files)} Text Files",
            "subtitle": "Primary search format",
            "arg": str(CONVERSATIONS_DIR),
            "icon": {"path": "/System/Library/CoreServices/CoreTypes.bundle/Contents/Resources/DocumentIcon.icns"}
        },
        {
    ...
    items.append({
        ...
        "arg": str(CONVERSATIONS_DIR),
        "icon": {"path": "/System/Library/CoreServices/CoreTypes.bundle/Contents/Resources/GenericFolderIcon.icns"}
    })
