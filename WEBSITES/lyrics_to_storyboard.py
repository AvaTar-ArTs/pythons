...
#!/usr/bin/env python3
"""
Summary of lyrics_to_storyboard.py
...
def fill_storyboard(song_title, lyrics):
    ...
    mapping = {
        ...
        "cue_cover": "hit_neon",
        "cue_trans1": "soft_glitch",
        "cue_main": "pressure_build",
        "cue_reflect": "warm_release",
...
def build_prompts(sb):
    ...
    for b in beats:
        if b["type"] == "cover":
            prompts.append(
                prompt_from_scene(
                    "Cover — Fracture State",
                    "bold_shattered",
                    "top",
                    b["typography"]["text"],
                    "high contrast, neon rim",
                    "teal/magenta + red accent",
                    b["prompt"],
                )
            )
            ...
            prompts.append(
                prompt_from_scene(
                    "Main — Surveillance Cathedral",
                    "dramatic_serif",
                    "in_world",
                    b["typography"]["text"],
                    "cold cyan beams",
                    "cyan/graphite + red alerts",
                    b["prompt"],
                )
            )
            ...
            prompts.append(
                prompt_from_scene(
                    "Reflection — Willow Ember",
                    "handwritten_faded",
                    "whisper",
                    b["typography"]["text"],
                    "warm ember vs moon blue",
                    "gold/blue",
                    b["prompt"],
                )
            )
