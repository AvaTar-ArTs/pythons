...
class EnhancedContentAnalyzer:
    ...
    def assess_business_value(self, file_info):
        ...
        if any(
            ...
            for cat in ["seo_optimization", "business_development"]
        ):
            value = "high"
        elif any(
        ...
        # Project-based value
        if any(
            "Dr. Adu" in proj or "Gainesville" in proj for proj in file_info["projects"]
        ):
            value = "high"
    ...
    def generate_batch_insights(self, batch_results):
        ...
        if batch_results["high_value_files"]:
            ...
            seo_files = [
                f
                for f in batch_results["high_value_files"]
                if "seo_optimization" in f.get("categories", [])
            ]
            if seo_files:
...
"""
    ...
    def run_enhanced_analysis(self):
        ...
        print("📋 Check ENHANCED_MASTER_ANALYSIS.md for comprehensive overview")
