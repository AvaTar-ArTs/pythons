...
def main():
    parser = argparse.ArgumentParser(description='Merge and cleanup Python backup directories')
    parser.add_argument('--analysis', required=True, help='Path to analysis JSON file')
    parser.add_argument('--duplicates', required=True, help='Path to duplicates JSON file')
    parser.add_argument('--merge-plan', required=True, help='Path to merge plan JSON file')
    parser.add_argument('--output', required=True, help='Output directory for merged backup')
