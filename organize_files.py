...
FILE_MAPPINGS = [
    ...
    ("unified_digital_dive_framework.yaml", "Frameworks", "digital_dive_v1_unified.yaml"),
    ("digital_dive_two_batch_template.yaml", "Frameworks", "digital_dive_v2_batch_template.yaml"),
