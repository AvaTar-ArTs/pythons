            ...
            if self.openai_client:
                response = self.openai_client.chat.completions.create(
                    ...
                    messages=[
                        {
                            "role": "system",
                            "content": "You are an expert Python code analyst. Provide clear, engaging, and accurate analysis.",
                        },
...
"""
    ...
    def _generate_markdown(self, scripts: list, by_category: dict) -> str:
        ...
        md = f"""# ?? AI-Analyzed Python Automation Arsenal

> **Intelligent Documentation** - Generated using GPT-4 and Claude for deep code understanding

## ?? Overview

This repository contains **{len(scripts)}** Python automation scripts, intelligently categorized and analyzed for optimal discovery and usage.

### ?? Categories at a Glance

{self._format_category_summary(by_category)}
