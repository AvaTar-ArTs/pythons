...
"""
    ...
    def _query_openai(self, prompt: str) -> dict | None:
    ...
    def _query_anthropic(self, prompt: str) -> dict | None:
    ...
    def determine_category(self, patterns: list[str]) -> str | None:
    ...
    def create_rename_plan(self, analyses: list[dict]) -> None:
        ...
        self.print_header(
            "CREATING INTELLIGENT RENAME PLAN",
            Colors.YELLOW,
            Emojis.BRAIN,
        )
            ...
            self.rename_plan.append(
                {
                    ...
                    "category": (
                        self.determine_category(analysis["patterns"])
