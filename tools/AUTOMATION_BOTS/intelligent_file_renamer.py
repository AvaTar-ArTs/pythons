...
class IntelligentFileRenamer:
    ...
    def suggest_better_name(self, filepath: Path, analysis: dict) -> str | None:
        ...
        for keyword in analysis.get("keywords", [])[:10]:
            if keyword in ["youtube", "instagram", "twitter", "facebook"] or keyword in ["image", "video", "audio", "text"]:
