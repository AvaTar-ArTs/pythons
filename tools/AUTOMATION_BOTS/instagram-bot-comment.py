...
def functionComment(mySystem):
    ...
    logger.info("")
    logger.info(r"\CONSTANT_33[0;32mCONFIGURATION\CONSTANT_33[m")
    logger.info("")
    ...
    logger.info("")
    logger.info(r"\CONSTANT_33[0;32mLOGIN INFORMATION\CONSTANT_33[m")
    logger.info("")
    ...
    logger.info("")
    logger.info(r"\CONSTANT_33[0;32mBOT INFORMATION\CONSTANT_33[m")
    logger.info("")
    ...
    try:
        ...
        logger.info(
            r"\CONSTANT_33[0;31mDRIVER ERROR!\CONSTANT_33[m Check installed drive or path.",
        )
    ...
    def likecomment(likes=1, comment=""):
        ...
        logger.info(
            rf"Number of photos liked and commented: \CONSTANT_33[0;33m{item - 1}\CONSTANT_33[m",
        )
    ...
    try:
        ...
        logger.info(r"\CONSTANT_33[0;33mProgram terminated by the user!\CONSTANT_33[m")

    except (ValueError, TypeError):
        print(
            r"\CONSTANT_33[0;31mUNEXPECTED ERROR ON LOGIN\CONSTANT_33[m, please try again and verify your connection!",
        )
    ...
    try:
        ...
        print(
            r"\CONSTANT_33[0;31mUNEXPECTED ERROR ON HASHTAG PAGE\CONSTANT_33[m, please try again and verify your connection!",
        )
    ...
    try:
        ...
        print(
            r"\CONSTANT_33[0;31mUNEXPECTED ERROR ON COMMENT\CONSTANT_33[m, please try again and verify your connection!",
        )
    ...
    press = input(r'\CONSTANT_33[0;34mpress "enter" to continue\CONSTANT_33[m ')
    os.system(mySystem)
