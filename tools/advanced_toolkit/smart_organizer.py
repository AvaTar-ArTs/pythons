    ...
    def _init_default_rules(self):
        ...
        self.rules.append(
            OrganizationRule(
                ...
                condition=lambda fp: fp.mime_type.startswith("audio/")
                and fp.metadata
                and fp.metadata.get("artist"),
        ...
        self.rules.append(
            OrganizationRule(
                ...
                condition=lambda fp: fp.mime_type
                in [
                    "application/pdf",
                    "application/msword",
        ...
        self.rules.append(
            OrganizationRule(
                name="archives",
                condition=lambda fp: fp.extension
                in [".zip", ".tar", ".gz", ".7z", ".rar"],
        ...
        self.rules.append(
            OrganizationRule(
                name="config",
                condition=lambda fp: fp.extension
                in [".conf", ".config", ".ini", ".yaml", ".yml", ".toml"],
...
class DuplicateManager:
    ...
    def choose_best_version(self, duplicates: List[Path]) -> Path:
        ...
        for path in duplicates:
            ...
            if any(
                keyword in path_str
                for keyword in ["BY_ARTIST", "BY_ALBUM", "ORGANIZED"]
            ):
                score += 10
            ...
            if any(
                ...
                for keyword in ["temp", "cache", "tmp", "backup"]
            ):
                score -= 5
    ...
    def generate_dedup_plan(self, duplicates: Dict[str, List[Path]]) -> Dict:
        ...
        plan = {"actions": [], "total_to_remove": 0, "space_to_save": 0}
