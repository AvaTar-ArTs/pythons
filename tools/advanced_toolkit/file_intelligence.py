...
class FileIntelligenceDB:
    ...
    def get_statistics(self) -> Dict:
        ...
        extensions = [
            {"ext": row[0], "count": row[1], "size": row[2]} for row in cursor
        ]
    ...
    def add_relationship(:
        self, file1_path: str, file2_path: str, rel_type: str, confidence: float
    ):
...
class FileAnalyzer:
    ...
    def scan_directory(:
        self, directory: Path, exclude_patterns: List[str] = None, max_files: int = None
