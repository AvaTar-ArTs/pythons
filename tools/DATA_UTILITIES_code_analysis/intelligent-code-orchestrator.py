...
class IntelligentCodeOrchestrator:
    ...
    async def _analyze_focus_area(
        ...
        try:
            ...
            return {
                ...
                "issues_found": (
                    len(analysis_text.split("Issue:")) - 1
                    if "Issue:" in analysis_text
                    else 0
                ),
                "recommendations": (
                    len(analysis_text.split("Recommendation:")) - 1
    ...
    def _create_analysis_prompt(
        ...
        if focus_area == "performance_optimization":
            return (
                base_prompt
                + """
