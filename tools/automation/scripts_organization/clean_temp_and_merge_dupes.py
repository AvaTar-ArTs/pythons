...
def main():
    ...
    if dup_dirs:
        print("\n💡 NEXT STEPS:")
        print("  • Review the duplicate directory groups above")
        print("  • Determine which directories to merge/consolidate")
        print("  • Consider keeping the most recent/complete version")
        print("  • Archive or remove redundant directories")
