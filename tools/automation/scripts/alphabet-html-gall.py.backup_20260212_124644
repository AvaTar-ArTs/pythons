...
def generate_grouped_gallery(folder_path, output_html, group_size=4):
    ...
    print(f"Grouped gallery saved at {output_html}")


# Example usage
folder_path = "/Users/steven/Pictures/leodowns/"  # Replace with your folder path
output_html = "/Users/steven/Pictures/leodowns/grouped_gallery.html"  # Output HTML path
