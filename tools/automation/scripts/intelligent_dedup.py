...
class IntelligentDeduplicator:
    ...
    def create_removal_plan(self):
        ...
        print(
            f"{Colors.GREEN}Space to save: {self.stats['space_saved'] / 1024 / 1024:.2f} MB{Colors.END}"
        )
    ...
    def generate_report(self):
        ...
        with open(report_file, "w") as f:
            ...
            f.write(
                f"| Space Saved | {self.stats['space_saved'] / 1024 / 1024:.2f} MB |\n"
            )
            ...
            for parent in sorted(by_parent.keys()):
                ...
                f.write(f"### 📁 {parent}\n")
                f.write(
                    f"**Removed:** {len(items)} files ({total_size / 1024:.1f} KB)\n\n"
                )
    ...
    def run(self):
        ...
        print(
            f"  💾 Space Saved: {Colors.CYAN}{self.stats['space_saved'] / 1024 / 1024:.2f} MB{Colors.END}\n"
        )
