        ...
        for source in source_dirs:
            ...
            for file in source_path.rglob("*"):
                if file.is_file() and not any(
                    skip in str(file)
                    for skip in [".git", "node_modules", "__pycache__", ".DS_Store"]
                ):
...
def main():
    ...
    for merge in merges:
        ...
        if existing_sources:
            merger.merge_directories(existing_sources, merge["target"], merge["name"])
    ...
    single_projects = {
        ...
        "Passive Income Empire": workspace
        / "revenue-projects/passive-income/passive-income-empire",
    ...
    print("   ? Report saved: MERGE_REPORT.md")
