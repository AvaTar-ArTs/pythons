...
CATEGORIES = {
    ...
    "Utilities & Tools": ["utility", "tool", "helper", "cli", "command line", "script"],
}
    ...
    def scan_directory(self):
        ...
        for project_name, files in projects_dict.items():
            ...
            category = self.categorize_project(
                project_name, description, analysis["imports"], str(main_file)
            )
...
"""
    ...
    def _generate_challenge(self, project):
        ...
        return challenges.get(
            project["category"],
            "Build efficient solution for complex technical problem",
        )
