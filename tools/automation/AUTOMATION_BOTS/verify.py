...
# Color codes
class Colors:
    GREEN = r"\CONSTANT_33[0;32m"
    RED = r"\CONSTANT_33[0;31m"
    YELLOW = r"\CONSTANT_33[1;33m"
    BLUE = r"\CONSTANT_33[0;34m"
    CYAN = r"\CONSTANT_33[0;36m"
    NC = r"\CONSTANT_33[0m"  # No Color
...
def test_ollama_connection():
    ...
    try:
        ...
        logger.info(
            f"{Colors.YELLOW}💡 Make sure Ollama is running: ollama serve{Colors.NC}",
        )
        return False
