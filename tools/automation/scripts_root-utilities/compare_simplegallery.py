...
ZIP1 = Path(
    "/Users/steven/Documents/Archives/gallery-projects/simplegallery_template.zip"
)
ZIP2 = Path(
    "/Users/steven/Documents/Archives/gallery-projects/simplegallery-Perfect.zip"
)
DIR1 = Path("/Users/steven/simplegallery")
DIR2 = Path("/Users/steven/simples")

OUTPUT = Path(
    "/Users/steven/Documents/Archives/duplicate_analysis/simplegallery_comparison.txt"
)
    ...
    try:
        for root, dirs, filenames in os.walk(dir_path):
            for filename in filenames:
                ...
                try:
                    stat = filepath.stat()
                    files[str(rel_path)] = {"size": stat.st_size, "date": stat.st_mtime}
                except:
                    pass
        return files
    except Exception as e:
...
def main():
    ...
    if zip1_contents and dir2_contents:
        results.append(
            compare_contents(
                "simplegallery_template.zip", zip1_contents, "~/simples", dir2_contents
            )
        )
    ...
    if zip2_contents and dir2_contents:
        results.append(
            compare_contents(
                "simplegallery-Perfect.zip", zip2_contents, "~/simples", dir2_contents
            )
        )
    ...
    if dir1_contents and dir2_contents:
        results.append(
            compare_contents(
                "~/simplegallery", dir1_contents, "~/simples", dir2_contents
            )
        )
