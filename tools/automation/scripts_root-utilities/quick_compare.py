...
with open(OUTPUT, "w") as f:
    ...
    if zip1_files and dir2_files:
        ...
        f.write(f"\n{'=' * 70}\n")
        f.write("COMPARISON: simplegallery_template.zip vs ~/simples/simplegallery\n")
        f.write(f"{'=' * 70}\n")
    ...
    if zip2_files and dir2_files:
        ...
        f.write(f"\n{'=' * 70}\n")
        f.write("COMPARISON: simplegallery-Perfect.zip vs ~/simples/simplegallery\n")
        f.write(f"{'=' * 70}\n")
    ...
    if zip1_files and zip2_files:
        ...
        f.write(f"\n{'=' * 70}\n")
        f.write("COMPARISON: simplegallery_template.zip vs simplegallery-Perfect.zip\n")
        f.write(f"{'=' * 70}\n")
