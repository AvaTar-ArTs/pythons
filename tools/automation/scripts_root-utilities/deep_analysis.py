    ...
    def generate_report(self, results: dict, recommendations: list):
        ...
        with open(report_file, "w", encoding="utf-8") as f:
            ...
            for dir_info in results["large_dirs"][:20]:
                f.write(
                    f"| `{dir_info[0]}` | {dir_info[1]:,} | {dir_info[2]:.1f} | {dir_info[3]:.1f} | {dir_info[4]} |\n"
                )
            f.write("\n")
            ...
            if old_files:
                ...
                for file_info in old_files[:30]:
                    f.write(
                        f"| `{file_info[0]}` | {file_info[1]:.2f} | {file_info[3]:.0f} |\n"
                    )
                f.write("\n")
            ...
            if nested:
                ...
                for file_info in nested[:30]:
                    f.write(
                        f"| `{file_info[0]}` | {file_info[1]} | {file_info[2]:.2f} |\n"
                    )
                f.write("\n")
...
def main():
    ...
    print("💡 Review the detailed report for full analysis")
    print()
