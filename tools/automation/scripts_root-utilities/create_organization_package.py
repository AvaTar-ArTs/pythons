...
def create_organization_package():
    ...
    files_to_include = {
        # Strategy documents
        "strategy/HOME_ORGANIZATION_STRATEGY.md": avatararts
        / "HOME_ORGANIZATION_STRATEGY.md",
        "strategy/ORGANIZATION_EXPORT_SUMMARY.md": avatararts
        / "ORGANIZATION_EXPORT_SUMMARY.md",
        # Database schema
        "database/unified_intelligence_schema.sql": avatararts
        / "unified_intelligence_schema.sql",
        # Organization tools
        "tools/duplicate_finder.py": avatararts
        / "organization-tools"
        / "duplicate_finder.py",
        "tools/downloads_categorizer.py": avatararts
        / "organization-tools"
        / "downloads_categorizer.py",
        "tools/database_inventory.py": avatararts
        / "organization-tools"
        ...
        "reports/HOME_DIRECTORY_DEEP_DIVE_REPORT.md": avatararts
        / "HOME_DIRECTORY_DEEP_DIVE_REPORT.md",
        "reports/HOME_DEEP_DIVE_ACTION_PLAN.md": avatararts
...
'\''
    ...
    instructions_file = (
        avatararts / f"ORGANIZATION_PACKAGE_INSTRUCTIONS_{timestamp}.txt"
    )
    ...
    with open(instructions_file, "w") as f:
        ...
        f.write("   cd organization-package/\n\n")
